...
This sample demonstrates how to use [MSAL React](https://www.npmjs.com/package/@azure/msal-react) to login, logout, conditionally render components to authenticated users, and acquire an access token for a protected resource such as Azure Function App (Post Endpoint).
...
* Acquiring an access token and calling protected Function App endpoint
...
2. Configure the URL for calling Function App endpint:
   2. Configure the string `"{Function App API URL}"` under "App.jsx".
